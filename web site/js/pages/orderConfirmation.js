...
window.Pages.orderConfirmation = (params) => {
  ...
  <div class="page-enter max-w-4xl mx-auto px-4 py-10">
    ...
    <!-- Success Banner -->
    <div class="bg-[#007d83] rounded-xl p-8 text-center text-white mb-8 shadow-xl">
    ...
    <div class="flex flex-wrap gap-4 justify-center">
      <button onclick="window.Router.navigate('/')" class="flex items-center gap-2 bg-[#007d83] hover:bg-[#006065] text-white font-bold px-8 py-3 rounded-xl transition-colors">
