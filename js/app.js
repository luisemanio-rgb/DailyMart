...
(function() {
  ...
  window.Router.define('/categories', function() {
    ...
    content.innerHTML = '<div class="page-enter max-w-7xl mx-auto px-4 py-8 pb-24 sm:pb-12">' +
      ...
      '<a href="#/" class="hover:text-[#007d83]">Home</a><span>/</span><span class="text-[#17212B] font-medium">All Categories</span>' +
      '</nav>' +
  ...
  window.Router.define('/deals', function() {
    ...
    content.innerHTML = '<div class="page-enter max-w-7xl mx-auto px-4 py-8 pb-24 sm:pb-12">' +
      '<nav class="flex items-center text-xs text-[#667085] mb-4 gap-1.5">' +
      '<a href="#/" class="hover:text-[#007d83]">Home</a><span>/</span><span class="text-[#17212B] font-medium">Today Deals</span>' +
      '</nav>' +
  ...
  window.Router.define('/fresh', function() {
    ...
    content.innerHTML = '<div class="page-enter max-w-7xl mx-auto px-4 py-8 pb-24 sm:pb-12">' +
      '<nav class="flex items-center text-xs text-[#667085] mb-4 gap-1.5">' +
      '<a href="#/" class="hover:text-[#007d83]">Home</a><span>/</span><span class="text-[#17212B] font-medium">Fresh Produce</span>' +
      '</nav>' +
      '<div class="mb-6 pb-3 border-b border-[#E5E7EB]">' +
  ...
  window.Router.define('/contact', function() {
    ...
    content.innerHTML = '<div class="page-enter max-w-3xl mx-auto px-4 py-12 pb-24 sm:pb-12 text-center">' +
      ...
      '<div class="w-10 h-10 rounded-lg bg-[#eefbfc] text-[#007d83] flex items-center justify-center mx-auto mb-3">' +
      (window.Icons ? window.Icons.render('phone', 'w-5 h-5') : '') +
      '</div>' +
      '<div class="font-bold text-[#17212B] text-sm mb-1">Helpline</div>' +
      '<div class="text-xs font-semibold text-[#007d83]">+880 1700-000000</div>' +
      ...
      '<div class="text-xs font-semibold text-[#007d83]">support@dailymartbd.com</div>' +
